          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _TextKey('F3', () => widget.onKeyTap('\x1bOR')),
                _TextKey('F4', () => widget.onKeyTap('\x1bOS')),
                _TextKey('F5', () => widget.onKeyTap('\x1b[15~')),
                _TextKey('F6', () => widget.onKeyTap('\x1b[17~')),
                _TextKey('F7', () => widget.onKeyTap('\x1b[18~')),
                _TextKey('F8', () => widget.onKeyTap('\x1b[19~')),
                _TextKey('F9', () => widget.onKeyTap('\x1b[20~')),
                _TextKey('F10', () => widget.onKeyTap('\x1b[21~')),
                _TextKey('F11', () => widget.onKeyTap('\x1b[23~')),
                _TextKey('F12', () => widget.onKeyTap('\x1b[24~')),
                const _GroupDivider(),
                // --- Symbols ---
                _TextKey('-', () => widget.onKeyTap('-'), repeat: true),
